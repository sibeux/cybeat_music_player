...
class HomeListScaleTap extends StatefulWidget {
  const HomeListScaleTap({
    super.key,
  ...
  @override
  HomeListScaleTapState createState() => HomeListScaleTapState();
}

class HomeListScaleTapState extends State<HomeListScaleTap>
