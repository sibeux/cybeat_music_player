...
class AddAllMusicAddModalEffectTap extends StatefulWidget {
  const AddAllMusicAddModalEffectTap({
    super.key,
    required this.child,
  });
  ...
  @override
  AddAllMusicAddModalEffectTapState createState() =>
      AddAllMusicAddModalEffectTapState();
}

class AddAllMusicAddModalEffectTapState
    extends State<AddAllMusicAddModalEffectTap>
